...
describe("converter", () => {
    ...
    it("must append a rotation effect", async () => {
        ...
        await applyImageEffects(sharp(), { rotate: "90" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a rotation effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { rotate: "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a flip effect", async () => {
        ...
        await applyImageEffects(sharp(), { flip: "weNeedToStandardizeThat" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append a flop effect", async () => {
        ...
        await applyImageEffects(sharp(), { flop: "weNeedToStandardizeThat" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append an affine effect", async () => {
        ...
        await applyImageEffects(sharp(), { affine: [ ".1",".2",".1",".7" ] }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append an affine effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { affine: ["2"] }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a sharpen effect", async () => {
        ...
        await applyImageEffects(sharp(), { "sharpen.sigma": ".7", "sharpen.m1": "1", "sharpen.m2": "2" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a sharpen effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "sharpen.sigma": "BAD_VALUE", "sharpen.m1": "1", "sharpen.m2": "2" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a median effect", async () => {
        ...
        await applyImageEffects(sharp(), { median: "3" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a median effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { median: "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a blur effect", async () => {
        ...
        await applyImageEffects(sharp(), { blur: "3" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a blur effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { blur: "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a flatten effect", async () => {
        ...
        await applyImageEffects(sharp(), { "flatten.background": "#00FF00" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a flatten effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "flatten.background": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a unflatten effect", async () => {
        ...
        await applyImageEffects(sharp(), { unflatten: "weNeedToStandardizeThat" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append a gamma effect", async () => {
        ...
        await applyImageEffects(sharp(), { gamma: [ "1", "2" ] }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a gamma effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { gamma: "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a negate effect", async () => {
        ...
        await applyImageEffects(sharp(), { "negate.alpha": "false" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append a normalize effect", async () => {
        ...
        await applyImageEffects(sharp(), { "normalize.upper": "99", "normalize.lower": "1" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a normalize effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "normalize.upper": "BAD_VALUE", "normalize.lower": "1" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>;
    ...
    it("must append a clahe effect", async () => {
        ...
        await applyImageEffects(sharp(), { "clahe.width": "100", "clahe.height": "100" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a clahe effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "clahe.width": "BAD_VALUE", "clahe.height": "100" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a convolve effect", async () => {
        ...
        await applyImageEffects(sharp(), { "convolve.width": "3", "convolve.height": "3", "convolve.kernel": [ "-1", "0", "1", "-2", "0" ,"2", "-1", "0", "1" ] }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a convolve effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "convolve.width": "3", "convolve.height": "3", "convolve.kernel": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a threshold effect", async () => {
        ...
        await applyImageEffects(sharp(), { "threshold": "128" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a threshold effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "threshold": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a boolean effect", async () => {
        ...
        await applyImageEffects(sharp(), { "boolean.operand": "/test/another.jpg", "boolean.operator": "and" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a boolean effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "boolean.operand": "/test/another.jpg", "boolean.operator": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a linear effect", async () => {
        ...
        await applyImageEffects(sharp(), { "linear.a": ".5", "linear.b": "2" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a linear effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "linear.a": "BAD_VALUE", "linear.b": "2" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a recomb effect", async () => {
        ...
        await applyImageEffects(sharp(), { "recomb.0": ["1", "1", "1"], "recomb.1": ["1", "1", "1"], "recomb.2": ["1", "1", "1"], }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a recomb effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "recomb.0": "BAD_VALUE", "recomb.1": ["1", "1", "1"], "recomb.2": ["1", "1", "1"], }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a modulate effect", async () => {
        ...
        await applyImageEffects(sharp(), { "modulate.hue": "80" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a modulate effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "modulate.hue": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append an extend effect", async () => {
        ...
        await applyImageEffects(sharp(), { "extend": "8" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append an extend effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "extend": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append an extract effect", async () => {
        ...
        await applyImageEffects(sharp(), { "extract.top": "0", "extract.left": "0", "extract.width": "100", "extract.height": "100" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append an extract effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "extract.top": "BAD_VALUE", "extract.left": "0", "extract.width": "100", "extract.height": "100" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>;
    ...
    it("must append a trim effect", async () => {
        ...
        await applyImageEffects(sharp(), { "trim": "weNeedToStandardizeThat" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append a tint effect", async () => {
        ...
        await applyImageEffects(sharp(), { "tint": "#00FF00" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append a tint effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "tint": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a grayscale effect", async () => {
        ...
        await applyImageEffects(sharp(), { "grayscale": "weNeedToStandardizeThat" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append a pipelineColorspace effect", async () => {
        ...
        await applyImageEffects(sharp(), { "pipelineColorspace": "rgb16" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it.skip("must fail to append a pipelineColorspace effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "pipelineColorspace": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a toColorspace effect", async () => {
        ...
        await applyImageEffects(sharp(), { "toColorspace": "rgb16" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it.skip("must fail to append a toColorspace effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "toColorspace": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>
    ...
    it("must append a removeAlpha effect", async () => {
        ...
        await applyImageEffects(sharp(), { "removeAlpha": "weNeedToStandardizeThat" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append an ensureAlpha effect", async () => {
        ...
        await applyImageEffects(sharp(), { "ensureAlpha": ".5" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append an ensureAlpha effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "ensureAlpha": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>;
    ...
    it("must append an extractChannel effect", async () => {
        ...
        await applyImageEffects(sharp(), { "extractChannel": "red" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append an extractChannel effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "extractChannel": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>;
    ...
    it("must append an joinChannel effect", async () => {
        ...
        await applyImageEffects(sharp(), { "joinChannel": "/test/other.png" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must append an bandbool effect", async () => {
        ...
        await applyImageEffects(sharp(), { "bandbool": "and" }, opts.allowedEffects, "/test/images", cachePath, true)
    ...
    it("must fail to append an bandbool effect", async () => {
        ...
        const res = await applyImageEffects(sharp(), { "bandbool": "BAD_VALUE" }, opts.allowedEffects, "/test/images", cachePath, true) as Err<Error>;
